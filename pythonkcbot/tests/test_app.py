...
def test_announce(mock_get_events, mock_create_api, mock_tweet):
    test_event = {
        ...
        "region": "us-west-2",
        "resources": ['arn:aws:events:us-west-2:1234567890:rule/testevents-dev-every-day'],
        "source": "aws.events",
    ...
    mock_get_events.return_value = (Event(name=e["name"], date=e["local_date"], link=e["link"], status=e["status"]) for e in meetup_events)
